...
namespace AdvancedFTPServer
{
    class MyHTTPClient
    {
        ...
        public MyHTTPClient(Socket ClientSocket)
        {
...
Last-Modified: Mon, 09 Apr 2018 06:13:19 GMT
Accept-Ranges: bytes
ETag: W/"d4a74adbc9cfd31:0"
Server: Microsoft-IIS/10.0
X-Powered-By: ASP.NET
Date: Mon, 09 Apr 2018 06:13:38 GMT
Content-Length: 5
...
Hello
            ...
            // 浏览器访问要1100毫秒 IIS静态网页10毫秒 Why
            StringBuilder sb = new StringBuilder();
            string content = "<h1>test html<h1>";
            sb.Append("HTTP/1.1 200 OK" + Environment.NewLine);
            sb.Append("Content-Type: text/html; charset=UTF-8" + Environment.NewLine);
            sb.Append("Date: Mon, 09 Apr 2018 05:56:14 GMT" + Environment.NewLine);
            sb.Append("Expires: Mon, 09 Apr 2018 05:57:14 GMT" + Environment.NewLine);
            sb.Append("Server: nginx" + Environment.NewLine);
            sb.Append("Vary: Accept-Encoding" + Environment.NewLine);
            sb.Append("X-Powered-By: PHP/5.6.30" + Environment.NewLine);
            int num = Encoding.UTF8.GetBytes(content).Length;
            sb.Append($"Content-Length: {num} " + Environment.NewLine);
